...
func TestApproverMatrix(t *testing.T) {
	...
	cases := []struct {
		...
		{"approver same tenant may list queue", onboardingInput([]string{"nimasa-officer"}, "nimasa", "nimasa", "list"), true},
		{"platform admin same tenant may list queue", onboardingInput([]string{"platform-admin"}, "nimasa", "nimasa", "list"), true},
		{"approver cross-tenant list denied", onboardingInput([]string{"nimasa-officer"}, "nimasa", "nwa", "list"), false},
		{"operator role cannot list queue", onboardingInput([]string{"nwa-officer"}, "nwa", "nwa", "list"), false},
		{"read-only auditor cannot list queue", onboardingInput([]string{"independent-auditor"}, "nimasa", "nimasa", "list"), false},
		{"empty tenant list denied", onboardingInput([]string{"nimasa-officer"}, "", "nimasa", "list"), false},
